import { ArrowLeft, Mail, Lock, Building2, MapPin, Globe, Phone, FileText } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="max-w-md mx-auto w-full px-4 py-12 flex-1">
        <Link to="/signup" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-8 transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back
        </Link>

        <h1 className="text-3xl font-semibold text-gray-900 mb-1">Create company account</h1>
        <p className="text-gray-500 mb-8">Build your employer brand and find top talent</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit" disabled={isLoading || !acceptedTerms}
